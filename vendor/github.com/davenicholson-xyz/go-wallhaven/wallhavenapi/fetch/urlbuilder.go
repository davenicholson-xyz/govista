...
func (u *URLBuilder) Append(path string) {
	u.baseURL += path
}
...
// If the ke     y doesn't exist or the value can't be parsed, it returns 0.
...
func (u *URLBuilder) Clone() *URLBuilder {
	clone := NewURL(u.baseURL)
